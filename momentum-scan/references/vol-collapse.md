...
Deep documentation for `--vol-collapse-ratio` (flag semantics and raise/lower guidance live in the SKILL.md parameter table). Read this file when an exclusion actually fires, the user asks where a name went, or you suspect a buyout leaked into the table.
