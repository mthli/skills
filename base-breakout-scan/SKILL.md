...
5. **Don't chase gap fills.** Fills > 3% above pivot averaged −11.5% (real cases — earnings/crypto-beta gaps, not data artifacts). Fills within 1-3% were fine. If the open blows through the pivot by >3%, skip or wait for the retest.
