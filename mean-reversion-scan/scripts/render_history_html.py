...
const I18N = {
  ...
  ko: {
    ...
    gridTitle: "결과 그리드",
    gridNote: () => `종목당 1행, 등재일마다 1셀, 색 = 그날 신호의 최종 결과. 중심에 점이 있는 셀은 ⭐ 포켓일 (Score ≥ ${DATA.pocket.minScore}, 등재 ${DATA.pocket.maxStreak}일 이내). __STUCK_MIN_STREAK__일 이상 끊기지 않는 긴 행은 정체된 과매도입니다. 반등이 오지 않은 경고이지 헐값이 아닙니다.\n행을 클릭하면 RSI(2) / 점수 / 손익 추이가 열립니다.`,
