...
// A grid cell carries three different kinds of fact, and as one flat list
// of sentences they read as a wall. Split them: which signal this is, what
// the setup measured and where its levels sat, how it ended.
