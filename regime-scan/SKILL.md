...
## What it pulls (all yfinance, ~110 tickers, one batched download)

- **Indices**: SPY, QQQ vs 50/200DMA + 200DMA slope; RSP/SPY (equal- vs cap-weight = the narrowing proxy)
- **Breadth**: % of a bundled **cross-sector large-cap universe** (`state/breadth_universe.txt`, ~97 names spanning all 11 sectors) above their 50/200DMA, plus 52-week new-highs − new-lows
...
- **Breadth universe is a fixed ~97 large-cap list**, not the full market. It captures dispersion well (even within megacaps, fewer hold their 50DMA as a tape narrows) but a true all-stock advance/decline line would be broader. Edit `state/breadth_universe.txt` to retune.
