...
It REUSES the regime-scan / momentum-scan / mean-reversion-scan caches that
the post-close daily-market-scan writes — never recompute them. If those
caches are stale (`regime.stale_days > 1`), say so in the briefing and lean
on the live tape.
